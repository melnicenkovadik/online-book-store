...
export default function CategoryForm({
  ...
  const [parentId, setParentId] = React.useState<string | "">(
    (initial?.parentId ?? undefined) ? String(initial?.parentId) : "",
  );
      ...
      const payload: Partial<Category> = {
        ...
        slug:
          ...
          name
            ...
            .replace(/\s+/g, "-")
            .replace(/[^a-z0-9-]/g, ""),
        // Category expects parentId: string | null with exactOptionalPropertyTypes
  ...
  return (
    <form onSubmit={submit} style={{ display: "grid", gap: 12, maxWidth: 560 }}>
      ...
      <div>
        <label htmlFor="slug" style={label}>
          Slug
        </label>
        <input
          id="slug"
      ...
      <div>
        <label htmlFor="parent" style={label}>
          Parent
        </label>
        <select
          id="parent"
