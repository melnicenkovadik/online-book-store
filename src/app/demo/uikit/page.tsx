    ...
    <div style={{ padding: 24, display: "grid", gap: 24 }} id="uikit-demo">
      ...
      <section id="uikit-buttons">
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          ...
          <Button id="btn-small" variant="primary" size="sm">
            Small
          </Button>
          <Button id="btn-large" variant="primary" size="lg">
            Large
          </Button>
        </div>
      </section>
      ...
      <section id="uikit-dropdown">
        ...
        <DropdownMenuRoot>
          <DropdownMenuTrigger asChild>
            <Button id="uikit-dropdown-trigger" variant="secondary">
              Open Menu
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent id="uikit-dropdown-content">
            <DropdownMenuItem
              id="uikit-dropdown-profile"
              onSelect={() => alert("Profile")}
            >
              Profile
            </DropdownMenuItem>
            <DropdownMenuItem
              id="uikit-dropdown-settings"
      ...
      <section id="uikit-modal">
        ...
        <ModalRoot open={open} onOpenChange={setOpen}>
          <ModalTrigger asChild>
            <Button id="uikit-modal-trigger" variant="primary">
              Open Modal
            </Button>
          </ModalTrigger>
          <ModalContent
            id="uikit-modal-content"
            title="Modal Title"
            description="Short description"
          >
            <p>Any content goes here.</p>
            <div style={{ marginTop: 12 }}>
              <Button id="uikit-modal-close" onClick={() => setOpen(false)}>
                Close
              </Button>
            </div>
          </ModalContent>
      ...
      <section id="uikit-select">
        ...
        <SelectRoot defaultValue="ua">
          ...
          <SelectContent id="uikit-select-content">
            <SelectItem id="uikit-select-ua" value="ua">
              Українська
            </SelectItem>
            <SelectItem id="uikit-select-en" value="en">
              English
            </SelectItem>
            <SelectItem id="uikit-select-pl" value="pl">
              Polski
            </SelectItem>
          </SelectContent>
        </SelectRoot>
      ...
      <section id="uikit-popover">
        ...
        <PopoverRoot>
          <PopoverTrigger asChild>
            <Button id="uikit-popover-trigger" variant="ghost">
              Open Popover
            </Button>
          </PopoverTrigger>
